...
- **2026-09-13 05:44:37 UTC:** Full fly effort elapsed **11h 39m 09s** since 2026-09-12 18:05:28; full-brain course correction elapsed **10h 09m 34s** since19:35:03. Motor-only implementation started **2026-09-13 05:04:49 UTC**, **39m 48s** earlier. These development clocks include discussion, debugging, evaluation, rendering and transfer, not continuous optimization.
- Preserved the height-input pilot: **181.722557 s** RTX4090 optimization, **5.930013 s** setup, **1.698960 s** evaluation. **8 offline neural sequences /106 updates /108,544 reused samples /14,000 distinct frames**, zero live physics worlds during fitting, **10,337,956,352 bytes** peak CUDA allocation. Height migration's first numerical check failed before training; the repeat separately reports bounded unchanged-parent CUDA variability. Both unassisted flights, all six ground cases and the fixed-activity hover intervention failed. Original reports/checkpoint and causal captures are retained.
- Implemented one canonical physical body and checkpoint-enforced physical identity for stand/walk/hover. Wings have zero body mass/inertia, no contacts or aerodynamics; independent angular response drives only the documented custom flight law. Disabled utility selection while retaining the existing graph and motor routing. Corrected the motor-review contact reduction to include the entire clip; preserved the first report and repeated its evaluation under a new name. **72 tests pass**, with known upstream PyTorch/dm-control warnings; Ruff passes.
- Motor-focus01: **180.624521 s** training, **8.497658 s** setup, **140.233420 s** collection/forward and **40.386593 s** backward/optimization. **32 worlds (11 stand /11 walk /10 hover),16 CPU physics threads**, CUDA graph/learning, **5 kHz physics /500 Hz control**, **162 updates /165,888 physical transitions /331.776 aggregate simulated seconds**. Peak CUDA allocation **9,411,618,816 bytes**. All160 completed episodes reach two seconds under80% reference assistance; all three unassisted cases fail.
...
- **2026-09-13 06:52:38 UTC:** Full fly effort elapsed **12h 47m 10s** since September12 at18:05:28 UTC. Full-brain correction elapsed **11h 17m 35s** since19:35:03. These are development clocks, not continuous training.
- Initial-form correction04–07 totals **601.830693s (10m01.831s)** of training, **536,576 physical transitions /1,073.152 aggregate simulated seconds**. All runs use **32 worlds (11 stand /11 walk /10 hover)**,16 native CPU MuJoCo threads, RTX4090 graph/learning,5kHz physics and500Hz control. Each has9,411,467,264 bytes peak CUDA allocation. Exact setup, collection, optimization and checkpoint hashes are in `docs/embodied_fly/runs/motor_focus_06/INITIAL_FORM_REPORT.json`.
- Run04:180.182772s,25% reference assistance, initial-form targets and ground-wing weight10; autonomous ground control regresses. Run05:181.025272s, zero executed reference assistance; ground control recovers. Run06:120.113071s, same recipe; standing height loss falls to1.01%. Run07:120.509577s, ground-wing weight100; wing accuracy worsens. Retain06 as the preferred development review. This is corrective online imitation, not PPO.
- Both ground cases in05/06/07 stay upright with permitted support for five seconds. Over matched first-two-second windows,06 standing height loss improves23.13%→1.01% and wing-angle RMS0.364→0.106rad; walking wing RMS improves0.234→0.0714rad. Initial states match03 exactly. These are development cases, not generalization evidence. Full posture/tracking gates still fail; hover falls.
- Four complete reviews each contain15s,750frames,1600×900,50fps and1× playback, including every failed case. Exact render/encode/full-decode times are in the report above. Every completed video is visually inspected and automatically opened. The first05 render encountered an incomplete transfer and produced no video; rendering resumed from the saved capture after transfer completed. Training was not repeated.
- **76 full-suite tests pass**, plus the updated initial-form training/checkpoint test; Ruff passes. Capture/model/checkpoint hashes and all failure traces are verified. The canonical body and all78 learned runtime outputs remain unchanged. Posture scores are measured checks; imitation optimizes corrective command labels. The goal stays active: wing-angle accuracy, flight, transitions, utility and survival integration remain unfinished.

- **2026-09-13 07:24:51 UTC:** Wing-response work started06:56:54 UTC,27m57s earlier. Full fly effort elapsed13h19m23s since September12 at18:05:28 UTC; full-brain correction elapsed11h49m48s since19:35:03. These clocks include development, discussion, transfer and rendering.
- Two frozen sensory-response probes took3.985166/4.017320s, plus2.563717/4.272073s setup. Each uses75 neural sequences and zero physical transitions or training updates. The probes replay recorded actions within5.67e-7 and4.62e-7 respectively; all source/capture/checkpoint hashes are retained.
- Motor-focus08: **181.009871s training /8.098675s setup**,127updates,130,048physicaltransitions,260.096aggregate simulated seconds.32worlds(11stand/11walk/10hover),16native CPU MuJoCo threads,RTX4090 graph/learning,5kHz physics/500Hz control. Collection/forward131.165949s;backward49.832624s;peakCUDA13,824,762,368bytes. Paired synthetic sensory examples add no physical worlds or transition counts.
- Local response supervision leaves body, input scaling and deployed architecture unchanged. Five-second evaluation costs5.487397s setup/32.891485s capture. Both ground cases remain upright with permitted support, but wing-angle accuracy and standing sag regress;hover falls. No numerical warnings. **Keep06 preferred**, do not promote08 based on an auxiliary loss.245failuretraces and allcapturecausality checks pass.
- Full review:15s/750frames/1600×900/50fps/1×,60.177483s render/encode/full decode. Sampled frames inspected and video automatically opened. **79 tests pass**,13known upstreamwarnings;Ruff passes atbc97107. No further source change after those checks. Goal remains active: ground wing precision, hover and later survival integration are incomplete.

- **2026-09-13 08:01:10 UTC:** Readout investigation started07:26:59 UTC,34m11s earlier. Full fly effort elapsed13h55m42s since September12 at18:05:28 UTC; full-brain correction elapsed12h26m07s since19:35:03. Development time includes code, tests, discussion, transfer, inspection and rendering.
- Two frozen wing-output fits use **32worlds/16native CPU MuJoCo threads**,5kHz physics/500Hz control,RTX4090 brain inference and ridge fitting. Each collects32,000physicaltransitions/64aggregate simulated seconds. Collection31.150358/31.473841s, setup5.250982/5.141391s. Total new physical experience64,000transitions/128simulated seconds. Synthetic observations and reused cached rows are counted separately.
- Actual fitting takes **0.170996/0.212640s**, setup1.533296/2.513395s. Only1,542existing wing-output parameters change. These are supervised closed-form fits, not PPO or end-to-end brain training. The second dataset pools112,000examples in9.079576s after verifying identical upstream features. Neither fit improves the preferred controller;06 remains selected.
- Two previous-command probes take3.530120/3.515242s plus3.776308/3.597831s setup,39neural sequences each,zero physics/transitions/training. All recorded-action replays match within7e-7. The sampled command maps do not show strong self-amplification; no new penalty is added from this hypothesis.
- Physical evaluations take31.768500/33.873253s plus5.218884/4.674592s setup,three complete5s cases each. Firstfit:standfalls/walkupright/hoverfalls. Secondfit:standupright/walkfalls/hoverlosesaltitude. All full tracking/posture gates fail;zero numerical warnings. Both fits preserve the exact shared body, fixed graph, motor-only context and non-wing parameters. All capture hashes, bounded actions and causal feedback verified.
- Two complete review films each have15s/750frames/1600×900/50fps/1×. Render/encode/full decode59.494779/60.252703s. Both are visually inspected and automatically opened. Updated the hover overlay to distinguish airborne stability from landing upright. No video is promoted as a successful motor policy.
- **83tests pass**,13known upstreamwarnings,48.85s;Ruff passes. Subsequent rendering-label change receives visual QA. New sources, reports, checkpoints, data splits and exact timings are retained. Stop six-output-row-only calibration; continue full sensory-to-motor learning. Ground wing precision, flight, transitions, learned utility and final survival integration remain incomplete; goal stays active.

- **2026-09-13 08:38:42 UTC:** Ground curriculum09/10 work began08:04:36 UTC. Latest clarification-only turn was revalidated before resuming motor learning at08:34:30 UTC; no training process was duplicated.
- Motor-focus09/10 total **361.548467s training**,264,192 physical transitions /528.384 aggregate simulated seconds. Both use32 worlds (16 standing /16 walking),16 CPU MuJoCo threads,5kHz physics,500Hz control and RTX4090 graph/learning. Setup8.816460/9.530943s; collection-forward130.998965/130.143900s; backward50.142515/50.244785s. Peak CUDA allocation13,824,745,472bytes each.
- Both three-task evaluations run all5s cases without resets. Capture33.540868/32.678591s; setup5.861885/6.022397s. No numerical warnings. Ground support is stable, but full posture/tracking gates fail and hover falls.10 largely loses forward walking. Preferred06 is preserved.
- Both15s review films are encoded, fully decoded (750 frames each), visually inspected and automatically opened. Render/encode58.900258s for10 and60.432509s for09. Reports retain every failed case and source/checkpoint/model hashes.
- Added direct physical-outcome motor PPO with canonical-body verification, all78 active outputs, frozen utility heads and no imitation rehearsal. Eight focused tests pass in5.48s, including actual physical collection, neural-core gradient, reset/timeout handling, checkpoint and optimizer continuation. Full suite and first bounded GPU outcome trial follow; no success is inferred from passing software tests.

- **2026-09-13 08:55:59 UTC:** This motor-outcome turn began08:34:30 UTC (21m29s). Full fly effort elapsed14h50m31s since September12 at18:05:28 UTC; full-brain correction elapsed13h20m56s since19:35:03. These are development clocks, including tests, transfer, rendering and review.
- Added explicit motor-only physical PPO with the same397-input/78-output MaleCNS actor (2,410,924parameters) and same physical body. Separate training-only critic has235,777parameters. All78 outputs are active, utility/intention weights frozen, no teacher or rehearsal data. **89tests pass in56.26s**,15known upstreamwarnings;Ruff and whitespace checks pass.
- Ground-outcome01/02 use32worlds (16stand /16walk),16native CPU MuJoCo threads,5kHz physics and500Hz control. RTX4090 handles the graph and learning. Combined actual training **365.265781s (6m05.266s)**,323,584physicaltransitions /647.168aggregate simulated seconds. Peak CUDA allocation9,644,186,624bytes each. This is not a matched GPU-physics benchmark.
- Run01:182.957318s training,6.593570s setup,166.133669s collection/inference,16.804158s PPO optimization,192,512transitions,47updates. Run02:182.308462s training,7.155512s setup,111.604189s collection/inference,70.691535s optimization,131,072transitions,288updates. Smaller actor steps1e-6 versus1e-5 permit more PPO updates within the same wall budget. No rehearsal time or synthetic physical experience is counted.
- Full three-task evaluations take32.619730/33.586125s capture plus5.794825/6.156384s setup.01 standing falls;02 restores upright ground behavior but standing wing posture still regresses relative to06. Walking wing error improves slightly in02;hover fails in both. All full gates remain failed and preferred06 is preserved. Zero numerical warnings. Initial physical states/observations match06 exactly.
- Both15s videos (750frames,1600×900,50fps,1x) are fully decoded, inspected and opened. Render/encode60.417210/59.758524s. Every saved failure and capture hash and causal bounded-action feedback is verified. Recorded-window analysis uses existing trajectories without new training or physics. Goal remains active; no successful motor release is claimed.

- **2026-09-13 09:22:48 UTC:** This turn began08:59:12 UTC (23m36s). Full fly effort elapsed15h17m20s since September12 at18:05:28 UTC; full-brain correction elapsed13h47m45s since19:35:03. These are development clocks, not uninterrupted training.
- Added training-only wing corrections to physical motor PPO. Same body,397inputs/78outputs, fixed graph and frozen utility/intention weights. Physical-return and weighted-supervision gradients are audited separately. **91tests pass in59.62s**,15known warnings;20focused checks pass in23.34s. The later standalone hover audit is executed directly and changes no controller behavior.
- Ground-outcome03/04 total **367.828153s (6m07.828s) training**,262,144physicaltransitions /524.288aggregate simulated seconds. Both use32worlds(16stand/16walk),16native CPU MuJoCo threads,5kHz physics/500Hz control;RTX4090 graph and learning. Supervised label presentations reuse actual collected frames and are not added to physical-experience totals.
- Run03:182.342745s training,6.754555s setup,112.291787s collection/inference,70.038626s optimization,283PPOupdates,144,896wing-label presentations;peakCUDA9,644,402,176bytes. Run04:185.485408s training,6.407774s setup,111.287628s collection/inference,74.183626s optimization,298updates,152,576label presentations;peakCUDA9,646,195,200bytes.04 resumes03 optimizer/critic/exploration state. Same actorlr1e-6 and auxiliary weight100.
- Independent three-task5s evaluations take32.969942/32.810814s capture plus5.546996/6.101201s setup. Both ground cases remain upright with valid support.03 halves standing wing RMS relative to06 (0.114→0.057rad) and lowers walking wing RMS (0.0631→0.0528rad);04 does not improve the complete result. All strict full-task gates still fail, including hover.03 is the next development parent;06 remains preserved. Zero numerical warnings.
- Two complete15s films (750frames,1600×900,50fps,1x) are encoded, fully decoded, visually inspected and opened. Render/encode60.353565/59.994738s. Capture hashes, exact initial-state comparisons, causal bounded control feedback and all failure-label traces are verified.
- Hover-clock audit01 uses3.320554s setup and0.004622s inspection, zero physics steps and zero training. It demonstrates different timer-driven teaching commands from identical current observations, while explicitly retaining the possibility of recurrent phase inference. This motivates a measured-state hover reference; no new flight controller or learned hover result is claimed.

- **2026-09-13 09:45:45 UTC checkpoint:** Current effort began09:26:52 UTC. Built a state-based training-only hover reference and tested five gain profiles on CPU:45.564123s stepping plus1.587636s setup,37,500transitions/75aggregate simulated seconds,zero training. The preceding three-task reference took10.475439s capture plus3.255465s setup,7,500transitions/15aggregate seconds. Selected teacher gains reduce full hover root error to1.209mm; no learned hover claim.
- Implemented optional frozen ground-actor targets, separate hover assistance and explicit task-loss weighting. Focused13tests pass in20.19s; complete97tests pass in67.46s. These are test runtimes, not training. Ground-outcome03 remains the development parent. The declared three-minute next pilot is pending at this source checkpoint.

- **2026-09-13 09:55:32 UTC checkpoint:** 28m40s since this effort began09:26:52UTC; full fly effort15h50m04s sinceSeptember12at18:05:28UTC. Development elapsed is not training time.
- Selected state-hover reference onLinux:5.289309s setup +16.189907s capture;7,500transitions/15aggregate simulated seconds,zero learning. Hover passes at1.209mm root error; inherited walking reference fails tracking. Canonical checkpoint/body fingerprint matches exactly.
- State-hover-retention01:180.791216s learning,9.812909s setup;144.470024s collection/forward and36.307506s optimization.151,552transitions,148updates,303.104aggregate simulated seconds.32worlds(11stand/11walk/10hover);16native CPU MuJoCo threads;RTX4090 inference/learning;peakallocatedCUDA9,441,672,192bytes. Ground executes actor only; hover collection is80%reference-assisted. Frozen ground reference remains unchanged.
- Unassisted full5s-per-command evaluation takes6.385944s setup +31.079010s capture. Walking wing posture passes;standing andhover fail. Candidate is archived, not promoted. Parent03 remains selected. All3training failure traces and allcapture/model/checkpoint hashes are verified.
- Teacher hover film:5s/250frames,render14.463047s. Full learned-candidate film:15s/750frames,render59.781641s. Both1600×900/50fps/1x, fully decoded, visually inspected and opened. No training process remains running at handoff; the goal remains active.

- **2026-09-13 10:24:34 UTC checkpoint:** Current goal turn began09:58:55UTC (25m39s). Full fly effort elapsed16h19m06s sinceSeptember12at18:05:28UTC. Development elapsed includes coding, analysis, transfer and rendering; it is not training time.
- Frozen-reset audit:12.548267s setup +11.961960s execution;16,000physical transitions/32aggregate simulated seconds,zero learning.32duplicate-start worlds retain exact initial inputs; frozen standing/hover failures persist. First-action numerical differences across load/mode/batch checks are below4.18e-7.
- Retention02/03 total361.791649s learning (6m01.792s),299,008physical transitions/598.016aggregate simulated seconds. Both32worlds(11stand/11walk/10hover),16native CPU MuJoCo threads,5kHz physics/500Hz control;RTX4090 graph/learning;peak CUDA9,441,672,192bytes.02:181.192194s learning,9.963105s setup,145.008356s collection,36.171425s optimization,151,552transitions,148updates.03:180.599455s learning,10.091920s setup,145.341525s collection,35.245028s optimization,147,456transitions,144updates.
-02reduces only the learning rate relative to01 and preserves both ground skills.03removes hover assistance but regresses walking;standing posture passes,hover stillfails.02is retained as the better combined development parent. No motor release is accepted.
- Full unassisted evaluations:02setup6.726523s/capture32.534879s;03setup7.726628s/capture32.252596s. Both use allthree5scommands with identical parent-comparison initialstates. Zero numerical warnings.200training failure traces, exact action mixtures and allcapture/model/checkpoint hashes verified.
- Both complete15s films are fully decoded,visuallyinspected andopened(750frames each,1600×900,50fps,1x). Render/encode60.529379s and60.478168s. Recorded-state lift/input analyses add no physics or learning. No training process remains running; goal remains active.

- **2026-09-13 11:03:19 UTC checkpoint:** Previous learning effort began10:29:05UTC; current continuation began10:56:20UTC. Wing-output01 completed180.427952s of learning,174,080physical transitions /348.160aggregate simulated seconds,170updates.32worlds(11stand/11walk/10hover),16native CPU MuJoCo threads,5kHz physics/500Hz actions;RTX4090 neural inference/learning. Setup10.316808s;collection175.683503s;optimization4.731924s;peakCUDA891,770,368bytes.
- Independent full5s-per-command evaluation:7.122419s setup +31.549435s capture,zero numerical warnings. Standing/walking support remains stable,wing posture regresses,hover fails. Candidate not selected. All495failure traces/31,680frames and full captures verified. The15s video is fully decoded,inspected andopened;750frames,1600×900,50fps,1x;render/encode60.324752s.
- New two-parameter physical search has three focused tests passing in3.78s,including actual canonical physics and candidate/export equivalence; initial arithmetic/selection checks passed2tests in1.02s. Fullsuite pending at this clock. Search is not yet run and is not counted as training.
- **2026-09-13 11:04:14 UTC:** Complete motor suite103passed in71.78s,23known dependency warnings;Ruff andGitLFSintegrity checks pass. These are validation clocks, separate from the pending physical search.

- **2026-09-13 11:15:57 UTC checkpoint:** Current continuation began10:56:20UTC(19m37s); full fly effort17h10m29s sinceSeptember12at18:05:28UTC. Development clocks include coding, analysis, transfer, tests and rendering.
- Sweep-search01:6.463909s setup +70.556188s search/packing/save.16candidates,32worlds,eightcandidates perbatch,fourcases each,two2s batches;64,000transitions/128aggregate simulated seconds. NativeCPUphysics5kHz/500Hzactions,RTXneuralinference,peakCUDA811,394,048bytes. Zero gradient updates. No candidate accepted; exact parent state retained.
- Rejected best-hover diagnostic:7.357387s setup +31.905167s fullthree-command capture,7,500transitions/15aggregate seconds. Zero numerical warnings;allstrictgatesfail. Film15s/750frames/1600×900/50fps/1x;60.403843s rendering,fullydecoded,inspected andopened. Both full search traces and full diagnostic captures independently verified,including27,030failedsearchworld/frames.
- Canonical state-readout implementation passes2focused tests in1.66s;actual source-data contract/causality checks pass for allthree2500-framehistories. Fullsuite andGPUfit pending at this clock. Replayed frames will not be added to physical-experience totals.

- **2026-09-13 11:23:36 UTC checkpoint:** Currentcontinuation27m16s since10:56:20UTC;fullflyeffort17h18m08s sinceSeptember12at18:05:28UTC;full-braincoursecorrection15h48m33s since19:35:03. These aredevelopmentelapsedtimes,nottraining.
- State-readout01:4.521751ssetup +13.565234sfrozenGPUreplay +0.928369sridgefit/packing/save =19.015356stotal. Threeparallelneuralhistories,6,000fitframes,1,500temporally-relatedvalidationframes,fiveregularizationcandidates. Zero new physicaltransitions;1,542existingoutputparameterseligible. NoCPU/GPUphysicsbenchmarkisclaimedforthisofflinefit.
- Fullindependentseed72003evaluation:7.295372ssetup +32.408363scapture;7,500transitions/15aggregatesimulatedseconds;3physicalworlds,5kHzphysics/500Hzactions. Zero numericalwarnings. Groundsupportstable,wingpostureandhoverfailed. Earlierparentretained. Independentfit/state/captureauditscompleted.
- Completevideo15s/750frames/1600×900/50fps/1x;60.334684srender/encode,fullydecoded,visuallyinspectedandopened. Thecomplete105-testsuitepassed72.93s(23dependencywarnings);Ruffpasses. Recorded-boundary/featurediagnosticsaddnointegrationorlearning.

- **2026-09-13 11:31:47 UTC:** This continuation began 11:26:08 UTC. Implemented actual-state correction loading and masked readout fitting. Five focused tests pass in 3.88 s; full 108-test suite passes in 74.52 s (23 dependency warnings). Source-data audit retains 116 and 822 pre-fall frames with zero integration. The declared GPU fit is pending and is not yet counted as training.

- **2026-09-13 11:47:06 UTC:** Current continuation began 11:26:08 UTC. State-readout02: 61.235897 s setup/relabeling, 13.663314 s frozen GPU replay, 1.866078 s fit/packing/save; 76.765293 s total. Five neural histories, 6,758 fit frames, 1,680 temporally related validation frames, 12,500 processed observation frames, zero new integrated transitions; peak allocated CUDA 664,091,648 bytes.
- Full independent three-command evaluation: 7.076312 s setup + 32.581429 s capture; 7,500 transitions / 15 aggregate simulated seconds. Standing upright, walking/hover failed; no candidate promoted. Zero numerical warnings. Film 15 s / 750 frames / 1600×900 / 50 fps / 1×, rendered in 59.989101 s, fully decoded, inspected and opened.
- NPZ caching fix produces bitwise identical labels in 0.103722/0.193787 s on Mac for 116/822 frames. Five focused tests pass in 3.94 s. New motor-cell readout: nine focused tests pass in 5.08 s, full 112-test suite in 75.33 s (23 dependency warnings). These are tests and offline checks, not new physical learning experience. The new readout fit is pending.

- **2026-09-13 11:58:51 UTC checkpoint:** Current continuation 32m43s since11:26:08UTC. Full fly effort17h53m23s sinceSeptember12at18:05:28UTC; full-brain correction16h23m48s since19:35:03UTC. These are development clocks, not uninterrupted training.
- Motor-cell readout01:5.491297s setup +13.887785s frozen GPU replay +5.385649s fit/packing/save =24.764732s total. Five neural histories;6,758 fitframes/1,680 temporallyrelatedvalidationframes;4,896 new decoder parameters;all original weights frozen. Zero newly integrated physical transitions;peakCUDA664,091,648bytes.
- Full5s-per-command evaluation:6.921002s setup +31.379153s capture;3physicalworlds,7,500transitions/15aggregate simulated seconds,5kHzCPU MuJoCo physics/500HzGPUbrain actions. Standingupright;walk/hoverfail;zero numericalwarnings. Earlierparentretained.
- Complete15s film:750frames,1600×900,50fps,1x;59.486772srender/encode,fullydecoded,inspectedandopened. The recorded-envelope audit adds nointegration orlearning. Twofits thiscontinuation total101.530025s including setup,replay,packing/save; the two evaluations add15,000physicaltransitions/30aggregatesimulatedseconds.

- **2026-09-13 12:31:30 UTC checkpoint:** This continuation began12:07:19UTC:24m11s development elapsed. Fullfly effort18h26m02s sinceSeptember12at18:05:28UTC; full-brain correction16h56m27s since19:35:03UTC. These include coding, tests, transfers, analysis and rendering, not uninterrupted training.
- Nonlinear cached readout:1.527266s setup +17.907381s fitting;19.509097s total including export.18,000updates;selected10,500;105,222new parameters. Five existing histories,6,758fit/1,680temporallyrelatedvalidationframes;zero new physics or graph replay;peakCUDA165,577,728bytes.
- Its complete evaluation:6.300667s setup +32.082729s capture;7,500physicaltransitions/15aggregate seconds. Standing upright,walking/hoverfailed,allstrictgatesfailed;zero numericalwarnings. Film15s/750frames/1600×900/50fps/1×;60.336619srender/encode;decoded,inspected,opened.
- Online corrective imitation:10.172478s setup +180.376794s training;174.544957s collection/forward,5.818723s backward/optimization.32worlds(11stand/11walk/10hover),16CPUphysics threads,RTX4090brain/learning;5kHzphysics/500Hzactions.174,080transitions/348.16aggregate simseconds,170updates;peakCUDA896,806,912bytes. All original weights frozen;105,222decoder parameters updated.
- Independent online-candidate evaluation:6.297731s setup +31.530508s capture;7,500transitions/15aggregate seconds. Standing/walking upright withvalid support,groundwingpostureandhoverfailed;zero numericalwarnings. Earliercheckpointretained. Firstmistyped-pathlaunchfailedbeforeanyrolloutandisnotcountedasphysicalexperience.
- Online film15s/750frames/1600×900/50fps/1×;60.252149srender/encode;fullydecoded,inspectedandopened. All493training failure traces verified. Focused tests5passed/1.39s then13passed/21.48s; complete suites115passed/75.24s then116passed/77.77s. Validation costs remain separate from learning.

- **2026-09-13 13:07:16 UTC checkpoint:** Current continuation began12:34:43UTC:32m33sdevelopment elapsed. Fullfly effort19h01m48s sinceSeptember12at18:05:28UTC;full-brain course correction17h32m13s since19:35:03UTC. These aredevelopment clocks,notuninterruptedtraining.
- Frozen feedback probes:5.506291ssetup+1.875014sdiagnostic beforeencoderlearning;4.439183ssetup+1.858781sdiagnostic after.75neural sequences each,zero newphysicsortraining updates;causalreplayerrors4.33e-7/5.07e-7.
- Wing_feedback01:10.227206ssetup+180.484524straining;146.945133scollection/forward and33.526860sbackward/optimization.32worlds(11stand/11walk/10hover),16CPUphysics threads,RTX4090brain/learning;5kHzphysics/500Hzactions.148,480transitions/296.96aggregatesimseconds,145updates;peakCUDA3,825,026,560bytes.107,014parameterseligible,including1,792existingsensorweights.
- Its fullreview:6.308202ssetup+32.135790scapture,7,500transitions/15aggregate seconds.Standing/hoverfall;walkingstablebutposturefails;allstrictgatesfail,zero numericalwarnings.144trainingfailuretracesverified.15s/750frame/1600×900/50fps/1×film rendered59.680450s,decoded,inspectedandopened.
