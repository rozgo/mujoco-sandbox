# Archived GPU continuation report

This historical report predates the complete GPU acquisition replay. See the [current measured report](GPU_REPORT.md) for the final policy trained from random weights.
...
[Watch the complete normal-speed film](../../previews/locomotion/graphite/adaptive_dog_complete_v2.mp4) · [Exact statistics, formulas and source hashes](GPU_CONTINUATION_REPORT.json)
