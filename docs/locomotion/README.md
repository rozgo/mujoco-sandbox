...
Latest: **[complete lower-leg and whole-leg loss](LIMB_LOSS.md)**. One policy scores **254/256** fresh removal trials and retains **32/32** healthy walking trials. Five short rounds used **9 min 57 s of additional training**; its selected ancestry totals 12 min 45 s including the healthy parent. [Watch all nine conditions in 4K](../../previews/locomotion/limb_loss_all_cases.mp4). Two whole-front-right trials miss the timed goal requirement; all survive with allowed support. Single removals on flat ground, with no policy switching.
