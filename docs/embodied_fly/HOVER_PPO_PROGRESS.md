...
The final checkpoint completes four ten-second flights. Velocity error is
...
| 05 | Continue same weights/optimizer/critic | 604.488 | 1,769,472 | 4/4 | 15.59 mm/s |
...
- Five PPO trials: **3,018.320992 s = 50 min 18 s**, **6,029,312 transitions**,
  **12,058,624 physics steps**, **3.350 hours of aggregate simulated experience**.
...
- Final stage: approximately **2,927 world/action transitions/s**, including
...
- Full fly suite: **229 passed**. GPU replay, frozen-parameter and resume checks
  pass. Every comparison video was fully decoded, inspected and opened locally.

The remaining weakness is vertical regulation. The final checkpoint reduces the
...
[Final run details and reproduction](runs/velocity_hover_ppo_05/SUMMARY.md).
