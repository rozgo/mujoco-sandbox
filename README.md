...
[Cinematic video styling with WaveSpeed](docs/video_styling/README.md) is a paused
presentation experiment, included in main for future work, that preserves the
original simulation footage.
